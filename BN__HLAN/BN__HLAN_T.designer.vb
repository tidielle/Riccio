Partial Public Class FRM__HLAN_T
  Inherits FRM__CHIL
  ...
  Public WithEvents pnPage4Fill As NTSInformatica.NTSPanel
  Public WithEvents pnPage4Sx As NTSInformatica.NTSPanel
  ...
  Public WithEvents ckFullVersion As NTSInformatica.NTSCheckBox
