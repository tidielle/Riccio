Public Class FRM__MSG2
  ...
  Public Overridable Sub InitializeComponent()
    ...
    Me.cmdOk.Name = "cmdOk"
    Me.cmdOk.Size = New System.Drawing.Size(79, 19)
    Me.cmdOk.TabIndex = 2
    Me.cmdOk.Text = "OK"
    '
    'edMess
    ...
    Me.cmdZoom.Location = New System.Drawing.Point(335, 32)
    Me.cmdZoom.Name = "cmdZoom"
    Me.cmdZoom.Size = New System.Drawing.Size(79, 19)
    ...
    Me.cmdAnnulla.Location = New System.Drawing.Point(335, 57)
    Me.cmdAnnulla.Name = "cmdAnnulla"
    Me.cmdAnnulla.Size = New System.Drawing.Size(79, 19)
  ...
  Public Overridable Sub cmdZoom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdZoom.Click
    ...
    Try
      nSeparaNote = CLN__STD.NTSCInt(Val(oMenu.GetSettingBus("BS--HLNT", "Opzioni", ".", "SeparaNote", "0", " ", "0")))  'Separa le note scelte in multiselezione da:  0=nessun carattere, 1=un cr+lf, 2=due cr+lf
  ...
  Public Overridable Sub FRM__MSG2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    Try
  ...
  Public Overridable Sub FRM__MSG2_ActivatedFirst(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ActivatedFirst
    Try
      If cmdZoom.Visible Then
        edMess.Focus()
      Else
        edMess.Enabled = False
        cmdOk.Focus()
      End If
