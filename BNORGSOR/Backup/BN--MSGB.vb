Public Class FRM__MSGB
  ...
  Public Overridable Sub FRM__MSGB_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    Try
  ...
  Public Overridable Sub FRM__MSGB_ActivatedFirst(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.ActivatedFirst
    Try
