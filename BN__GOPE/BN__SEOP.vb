...
#Region "Eventi Form"
  Public Overridable Sub FRM__SEOP_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    Try
      ...
      If oCleGope.bNew = True Then
        Me.Text = oApp.Tr(Me, 130420516749533908, "Nuovo operatore")
      ElseIf oCleGope.bNew = False Then
        Me.Text = oApp.Tr(Me, 130420516820315611, "Apri operatore")
      End If
      '-------------------------------------------------
...
#End Region
  ...
  Public Overridable Sub InitControls()
    ...
    Try
      edOpNome.NTSSetParam(oMenu, oApp.Tr(Me, 129024305608039223, "Nome Operatore"), 20, True)
...
#Region "Eventi"
  Public Overridable Sub cmdConferma_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdConferma.Click
    Try
      If edOpNome.Text.Trim = "" Then
        oApp.MsgBoxErr(oApp.Tr(Me, 130397213467577743, "Indicare il nome dell'operatore"))
        Return
      End If
      If oCleGope.SeopValidaNomeOp(edOpNome.Text, oCleGope.bNew) Then
