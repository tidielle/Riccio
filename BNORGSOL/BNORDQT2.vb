...
Public Class FRMORDQT2
  ...
  Public bNewRow As Boolean = False

  Private components As System.ComponentModel.IContainer

  Private Sub InitializeComponent()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FRMORDQT2))
    ...
    Me.grTco.Location = New System.Drawing.Point(0, 26)
    Me.grTco.MainView = Me.grvTco
    Me.grTco.Name = "grTco"
    Me.grTco.Size = New System.Drawing.Size(492, 147)
    Me.grTco.TabIndex = 4
  ...
  Public Overridable Sub InitEntity(ByRef cleGsol As CLEORGSOL, ByRef dtrCorpo As DataRow)
    oCleGsol = cleGsol
    dtrEc = dtrCorpo
...
#Region "Eventi di Form"
  Public Overridable Sub FRMORDQT2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
  ...
  Public Overridable Sub FRMORDQT2_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
    If bVisDoc = False Then
      If Not Salva() Then e.Cancel = True
    End If
  End Sub

  Public Overridable Sub FRMORDQT2_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
    Try
      dcDqta.Dispose()
      dsDqta.Dispose()
    Catch
...
#End Region
  ...
  Public Overridable Function Salva() As Boolean
    ...
    Try
      ...
      If oCleGsol.dttET.Rows(0)!et_tipork.ToString = "H" Then
        If bNewRow = False Then
          oApp.MsgBoxErr(oApp.Tr(Me, 128587650648906250, "ATTENZIONE" & vbCrLf & _
                                 "Non è possibile cambiare le quantità per taglia" & vbCrLf & _
                                 "in una proposta d'ordine di produzione" & vbCrLf & _
                                 "di un articolo a Taglie e Colori."))
