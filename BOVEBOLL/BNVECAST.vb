...
Public Class FRMVECAST
  ...
  Private Sub InitializeComponent()
    Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FRMVECAST))
  ...
  Public Overridable Sub FRMVECAST_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    Dim i As Integer = 0
    Try
      '-------------------------------------------------
      ...
      edDtcomiva.Text = NTSCDate(oCleBoll.dttET.Rows(0)!et_dtcomiva).ToShortDateString
      edDiffDA.Text = NTSCDec(oCleBoll.dttET.Rows(0)!et_diffda).ToString
      edDiffIva.Text = NTSCDec(oCleBoll.dttET.Rows(0)!et_diffiva).ToString
  ...
  Public Overridable Sub FRMVECAST_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
    Try
      grvIva.Focus()
      If Not Salva() Then
        e.Cancel = True
  ...
  Public Overridable Sub tlbRipristina_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles tlbRipristina.ItemClick
    Try
      If grControp.ContainsFocus Then
        ...
        oCleBoll.CastRipristinaControp(dcContr.Position, dcContr.Filter)
        grvControp.NTSRipristinaRigaCorrenteAfter()
      Else
        If Not grvIva.NTSRipristinaRigaCorrenteBefore(dcIva, True) Then Return
        oCleBoll.CastRipristinaIva(dcIva.Position, dcIva.Filter)
...
#End Region
  ...
  Public Overridable Function Salva() As Boolean
    Try
      ...
      If grControp.ContainsFocus Then
        dRes = grvControp.NTSSalvaRigaCorrente(dcContr, oCleBoll.RecordIsChanged, False)
      Else
        dRes = grvIva.NTSSalvaRigaCorrente(dcIva, oCleBoll.RecordIsChanged, False)
      End If
      ...
      Select Case dRes
        Case System.Windows.Forms.DialogResult.Yes
          ...
          If grControp.ContainsFocus Then
            If Not oCleBoll.CastSalvaControp(False) Then
              Return False
            End If
          Else
            If Not oCleBoll.CastSalvaIva(False) Then
              Return False
            End If
          End If
        ...
        Case System.Windows.Forms.DialogResult.No
          'ripristino
          If grControp.ContainsFocus Then
            oCleBoll.CastRipristinaControp(dcContr.Position, dcIva.Filter)
          Else
            oCleBoll.CastRipristinaIva(dcIva.Position, dcIva.Filter)
          End If
  ...
  Public Overridable Sub cmdControlla_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdControlla.Click
    Try
      ...
      oCleBoll.CastControllaCastelletti()
    Catch ex As Exception
      '-------------------------------------------------
      Dim strErr As String = CLN__STD.GestError(ex, Me, "", oApp.InfoError, oApp.ErrorLogFile, True)
      '-------------------------------------------------	
